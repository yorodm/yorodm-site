+++
title = "Lisp y la belleza"
date = 2019-06-11T14:26:22-04:00
tags = ["common lisp","code conventions","productivity"]
draft = true
description = "La estética del código legible"
+++

Si hay algo que todos los desarrolladores odiamos es el código de otras personas

```common-lisp

(defclass pqueue ()
  ((elements :initform
                (make-array 15 :fill-pointer 0 :adjustable t)
             :accessor elements))
    (:documentation
	    "A vector based priority queue. Elements must be an ALIST (PRIORITY . ITEM)"))
